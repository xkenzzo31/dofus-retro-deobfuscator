...
public class V8_InjectThrow  extends V8_InjectPayload {
	...
	public PcodeOp[] getPcode(Program program, InjectContext context) {
		...
		Integer funcType = 0;
		// In V8 8.7, ThrowReferenceErrorIfHole can appear with Wide/ExtraWide prefixes.
		// Use contains() to match "ThrowReferenceErrorIfHole", "Wide.ThrowReferenceErrorIfHole",
		// and "ExtraWide.ThrowReferenceErrorIfHole".
		if (instruction.getMnemonicString().contains("ThrowReferenceErrorIfHole")) {
			fIdx = 1;
