...
//	}
	...
	public PcodeOp[] getPcode(Program program, InjectContext context) {
		...
		// V8 8.7: CallRuntime/InvokeIntrinsic layout is [runtime_id, reg(reglist), uimm(count)].
		// The register list starts at operand index 1, not 2.
		// CallWithSpread/CallProperty have the same shift: callee at 0, reglist at 1.
		// For PROPERTYTYPE (CallProperty*), the callee register is at opIndex 0 and the reglist at 1.
		Object[] tOpObjects = instruction.getOpObjects(1);
